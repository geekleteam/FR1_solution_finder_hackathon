    ...
    <div className="flex flex-col items-center justify-center h-full">
      <div className="flex flex-col items-center justify-center mt-12">
        <h2 className="mb-4 text-3xl font-extrabold leading-tight text-center lg:text-4xl text-dark-grey-900">
          Elevate Your Productivity with Tentacle
        </h2>
        <p className="text-lg text-center lg:w-7/12 text-grey-700">
          Unlock the full orem Ipsum is simply dummy text of the printing
          and typesetting industryuding versions of Lorem Ipsum.ficiently.
        </p>
      </div>
      <div className="grid grid-cols-1 gap-10 mt-20 lg:grid-cols-3 md:grid-cols-2">
        <div className="flex flex-col items-center col-span-1 gap-6 px-10 py-5">
          ...
          <div className="flex flex-col gap-2 px-2 text-center">
            ...
            <p className="font-medium text-grey-700">
              Streamline communication within your team using our shared
              team inboxes. Enhance collaboration and keep everyone on the
              same page effortlessly.
            </p>
          </div>
        </div>
        <div className="flex flex-col items-center col-span-1 gap-6 px-10 py-5 bg-white shadow-main rounded-3xl">
          ...
          <div className="flex flex-col gap-2 px-2 text-center">
            ...
            <p className="font-medium text-grey-700">
              Gain valuable insights and data analytics for your team
              through our analytics dashboard. Make informed decisions and
        ...
        <div className="flex flex-col items-center col-span-1 gap-6 px-10 py-5">
          ...
          <div className="flex flex-col gap-2 px-2 text-center">
            ...
            <p className="font-medium text-grey-700">
              Deliver instant answers to your customers or team members with
              our shared team inboxes. Ensure quick responses and efficient
              problem-solving.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center col-span-1 gap-6 px-10 py-5">
          ...
          <div className="flex flex-col gap-2 px-2 text-center">
            ...
            <p className="font-medium text-grey-700">
              Integrate our shared team inboxes seamlessly with your
              website. Enhance the user experience and provide efficient
