...
const ChatInterface = () => {
  ...
  return (
    <div className="flex flex-col gap-5 ">
      {/* Chat container */}
      <div className="flex flex-col h-[650px] w-full max-w-2xl ml-10 border border-gray-300 rounded-lg overflow-hidden">
        {/* Top bar */}
        <div className="bg-white shadow-sm p-4 flex items-center justify-between">
          <div className="flex items-center">
            <h1 className="text-xl font-bold">Chat with Receptionist AI</h1>
          </div>
      ...
      <div className="m-5">
        <Link
          className="bg-gray-500 text-white rounded-md px-4 py-2 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
          to="/dashboard/table"
        >
          Create Comparison Table from a Template 📝
        </Link>
      </div>
      <div className="m-5">
        <Link
          ...
          to="/dashboard/table"
        >
          Generate Random Comparison Table 🎲
        </Link>
      </div>
      </div>
    </div>
