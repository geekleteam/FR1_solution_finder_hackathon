...
if AUTH0_DOMAIN is None:
    raise EnvironmentError("The environment variable 'AUTH0_DOMAIN' is not set.")
...
def sandbox():
    ...
    sandbox = service.create_sandbox(
        contextUrl=request.json["context_url"])
    return sandbox
...
def sandbox_get():
    ...
    return service.get_sandbox(sandboxId=request.args.get("id"))
